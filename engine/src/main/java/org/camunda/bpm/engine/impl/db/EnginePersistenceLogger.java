...
public class EnginePersistenceLogger extends ProcessEngineLogger {
  ...
  public ProcessEngineException flushDbOperationUnexpectedException(DbOperation failedOperation,
                                                    List<DbOperation> operationsToFlush,
                                                    Throwable cause) {
    String exceptionMessage = exceptionMessage(
      "083",
      "Unexpected exception while executing Database Operation '{}' with message '{}'. Flush summary: \n {}",
